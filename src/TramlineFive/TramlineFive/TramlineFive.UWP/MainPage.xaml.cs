...
namespace TramlineFive.UWP
{
    public sealed partial class MainPage
    {
        public MainPage()
        {
            ...
            LoadApplication(new TramlineFive.App());

            UpdateBounds(ApplicationView.GetForCurrentView().VisibleBounds);
            ApplicationView.GetForCurrentView().VisibleBoundsChanged += (view, sender) =>
            { UpdateBounds(view.VisibleBounds); };
        }
