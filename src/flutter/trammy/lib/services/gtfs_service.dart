...
static Future<void> updateGTFS({
  ...
  final request = await http.Client().send(http.Request('GET', Uri.parse(gtfsUrl)));
  ...
  static Future<List<Map<String, dynamic>>> getAllStops() async {
    await init();
    return _db!.query('stops', orderBy: 'stop_name ASC');
  }

  /// Example query: get all routes
  static Future<List<Map<String, dynamic>>> getAllRoutes() async {
    return _db!.query('routes', orderBy: 'route_long_name ASC');
  }
}